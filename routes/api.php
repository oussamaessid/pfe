...
//table event
Route::get('/events', [EvenementController::class, 'indexx']);
...
Route::post('/upload', [EvenementController::class, 'upload']);
...
Route::group([
    ...
    Route::get('/users', [PersonneController::class, 'index']);
    Route::post('/password/change', [AuthentificationController::class, 'changePassword']);
